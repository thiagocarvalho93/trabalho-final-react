  ...
  const getCep = async (cep) => {
    ...
    try {
      const { data } = await axios.get(
        `https://teg-store-api.herokuapp.com/tegloja/cep/${cep}`
      );
      setCep(data);
    } catch (e) {}
  };
        ...
        <form className="mt-4 shadow p-3 mb-5 bg-body rounded-3">
          ...
          <div className="row g-3 mt-2 mb-6">
            <div className="col-md-6 ">
              <label>
                {" "}
                <span className="obrigatorio"> * </span> Nome:
                <input
                  type="text"
              ...
              <div className="Endereco">
                <label>
                  ...
                  <input
                    ...
                    onBlur={handleBlur}
                  />
                  Numero: <span className="spanUF">UF:</span>{" "}
                  ...
                  <input
                    ...
                    className="form-control cadastro"
                    name="complemento"
                    placeholder="Complemento caso houver"
                    value={complemento}
